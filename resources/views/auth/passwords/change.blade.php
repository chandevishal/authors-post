            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.change.update') }}">
                        ...
                        <div class="row mb-3">
                            <label for="new-password-confirmation" class="col-md-4 col-form-label text-md-end">{{ __('Re-enter Password') }}</label>
                            <div class="col-md-6">
                                <input id="new-password-confirmation" type="password" class="form-control @error('new-password-confirmation') is-invalid @enderror" name="new-password-confirmation" required>
